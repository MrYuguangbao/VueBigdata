!function (a) {
    ...
    $(document).ready(function () {
        ...
        mainObj.judgeBro() && ($("#style").attr("href", "css/style_ie2.0.css"),
            mainObj.scrollSetPos(), $(window).scroll(function () {
            mainObj.scrollSetPos()
        })),
            setTimeout(function () {
            ...
            $(document).mousewheel(function (a, b) {
                a = a || window.event,
                    a.preventDefault(),
                    0 > b ? mainObj.scroll_To(mainObj.getNextSuffix(!0)) : 0 != mainObj.suffix && mainObj.scroll_To(mainObj.getNextSuffix(!1))
            }),
...
var mainObj = {
    ...
    resizeFn: function () {
        ...
        switch (!0) {
            case 780 > b || 780 > a:
                c.addClass(d).removeClass(e);
                break;
            case 1024 > b || 850 > a:
                c.addClass(e).removeClass(d);
                break;
            default:
                c.removeClass(e).removeClass(d)
        }
    },
